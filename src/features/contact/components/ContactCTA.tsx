...
export function ContactCTA() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative max-w-2xl mx-auto text-center px-4 py-16 rounded-2xl border border-border bg-surface overflow-hidden"
    >
      {/* Background glow */}
      ...
      <div className="relative z-10">
        ...
        <p className="text-muted-light text-lg mb-8 max-w-lg mx-auto">
          Hablemos sobre cómo puedo ayudarte a crear un sitio web que genere
